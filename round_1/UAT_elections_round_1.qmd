...
<qgis version="3.8.3-Zanzibar">
  <identifier>Turul 1</identifier>
  <parentidentifier>Alegeri Prezidentiale Romania</parentidentifier>
  <language>ROU</language>
  <type>dataset</type>
  <title>Alegerile Prezidențiale din 2019 în România - Date geografice la nivel de UAT, Turul 1</title>
...
Rezultate:
  Fișierul rezultat în urma Join-ului a fost exportat ca ESRI shapefile, cu numele UAT_elections_round_1, EPSG 3844, și encoding UTF8.
...
Alte considerente:
  ...
  Putem ajunge la cele două nivele de generalizare de mai sus și pornind de la fișierul UAT_elections_round_1.
  </abstract>
